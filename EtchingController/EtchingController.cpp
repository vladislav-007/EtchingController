...
// EtchingController.cpp : Определяет поведение классов для приложения.
//
...
// создание CEtchingControllerApp
...
// Единственный объект CEtchingControllerApp

CEtchingControllerApp theApp;


// инициализация CEtchingControllerApp
...
// обработчики сообщений CEtchingControllerApp
