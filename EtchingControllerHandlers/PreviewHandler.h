...
#include <afxext.h>
#include "..\EtchingController\EtchingControllerDoc.h"
#include "..\EtchingController\EtchingControllerView.h"
...
protected:
	...
	DECLARE_DOCUMENT(CEtchingControllerDoc)
...
public:
	virtual HRESULT InitializeDocumentPreview(HWND hWndParent, RECT* prc)
	{
		...
		CCreateContext ctx;
		ctx.m_pNewViewClass = RUNTIME_CLASS(CEtchingControllerView);
		...
		m_pDocument->AddRef();
		ctx.m_pCurrentDoc = DYNAMIC_DOWNCAST(CEtchingControllerDoc, (CObject*) m_pDocument->GetContainer());
